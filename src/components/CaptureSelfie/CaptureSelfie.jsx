...
const CaptureSelfie = () => {
  ...
  const handleSubmit = async () => {
    ...
    if(userData.investor) {
      response = await axios.post(`${process.env.REACT_APP_BACKEND_URL_PROD}/investor/submitKYCDetails`,
      k, {
      headers: {
    ...
    response = await axios.post(`${process.env.REACT_APP_BACKEND_URL_PROD}/teamMember/submitKYCDetails`,
      k, {
      headers: {
        "apiKey": userData.apiKey,
        "content-type": "application/json"
